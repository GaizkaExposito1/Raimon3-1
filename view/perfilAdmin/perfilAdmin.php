	...
	<div class="container">
		...
		<div class="right" id="right">
			...
			<div id="datosPerfil">
				...
				<br />
				<a href="#mensajesAprobados" id="mensajesAprobados"><?php echo $language["MENSAJES_APROBADOS"]; ?></a>
				<a href="#mensajesNoAprobados" id="mensajesDenegados"><?php echo $language["MENSAJES_DENEGADOS"]; ?></a>
